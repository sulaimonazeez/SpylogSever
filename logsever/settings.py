...
SIMPLE_JWT = {
    ...
    "REFRESH_TOKEN_LIFETIME": timedelta(days=1),  # You can ignore this if not using refresh
}
...
SECRET_KEY = 'django-insecure-5t78fuplav7k50n4e64)wxu_i$a06vq5xmzvkf2n@qk55#-(7('
...
WSGI_APPLICATION = 'logsever.wsgi.application'
